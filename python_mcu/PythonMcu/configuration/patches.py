control_mapping = {
    ...
    "Minimoog": {
        ...
        "Osc4 Octave":    "Range Osc3",
        "Osc4 Fine":      "Osc tuning3",
        "Osc4 Shape":     "Waveform Osc3",
    ...
    "Solina": {
        "Osc Detune":     "Oscillator detune",
        "Osc PWM Depth":  "Oscillator PWM Depth",
        "Osc PWM Freq":   "Oscillator PWM Frequency",
        "Osc Enhance 4'": "Oscillator enhance 4'",
        "Osc HP 4'":      "Oscillator HP Cutoff 4'",
        "Filt HP 4'":     "Filters HP Cutoff 4'",
        "Filt LP 4'":     "Filters LP Cutoff 4'",
        "Mix Gain 4'":    "Mix Gain 4'",
        "Osc Enhance 8'": "Oscillator enhance 8'",
        "Osc HP 8'":      "Oscillator HP Cutoff 8'",
        "Filt HP 8'":     "Filters HP Cutoff 8'",
        "Filt LP 8'":     "Filters LP Cutoff 8'",
        "Mix Gain 8'":    "Mix Gain 8'",
        "Env Attack":     "Envelope attack",
        "Env Hold":       "Envelope hold",
        "Env Decay":      "Envelope decay",
        "Env Sustain":    "Envelope sustain",
        "Env Release":    "Envelope release",
        "Chorus":         "Chorus enabled",
        "Chorus Depth":   "Chorus global depth",
        "Chorus Rate 1":  "Chorus rate 1",
        "Chorus Depth 1": "Chorus depth 1",
        "Chorus Rate 2":  "Chorus rate 2",
        "Chorus Depth 2": "Chorus depth 2",
        "Chorus Model":   "Chorus model",
        "Polyphony":      "Polyphony",
        "Volume":         "Master Gain",
    }
}
...
patches = {
    ...
    "Minimoog": {
        "groups": [
            {"name": "OSC1-2", "layout": "track"}, 
            {"name": "OSC3-4", "layout": "track"}, 
        ...
        "F0": {"name": "Osc1 Octave",      "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 0 },  "value": 91 },
        "F1": {"name": "Osc1 Fine",        "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 1 },  "value": 91 },
        "F2": {"name": "Osc1 Shape",       "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 2 },  "value": 91 },
        "F3": {"name": "Osc1 Level",       "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 3 },  "value": 64 },
        "F4": {"name": "Osc2 Octave",      "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 4 },  "value": 91 },
        "F5": {"name": "Osc2 Fine",        "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 5 },  "value": 91 },
        "F6": {"name": "Osc2 Shape",       "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 6 },  "value": 91 },
        "F7": {"name": "Osc2 Level",       "groups": ["OSC1-2",],     "set": "vtrack_setter", "param": { "track": 7 },  "value": 64 },

        "F8":  {"name": "Osc3 Octave",      "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 8 },   "value": 91 },
        "F9":  {"name": "Osc3 Fine",        "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 9 },   "value": 91 },
        "F10": {"name": "Osc3 Shape",      "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 10 },  "value": 91 },
        "F11": {"name": "Osc3 Level",      "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 11 },  "value": 64 },
        "F12": {"name": "Osc4 Octave",     "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 12 },  "value": 91 },
        "F13": {"name": "Osc4 Fine",       "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 13 },  "value": 91 },
        "F14": {"name": "Osc4 Shape",      "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 14 },  "value": 91 },
        "F15": {"name": "Osc4 Level",      "groups": ["OSC3-4",],     "set": "vtrack_setter", "param": { "track": 15 },  "value": 64 },

        "F16": {"name": "VCA  Attack",     "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 16 },  "value": 91 },
        "F17": {"name": "VCA  Decay",      "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 17 },  "value": 91 },
        "F18": {"name": "VCA  Sustain",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 18 }, "value": 91 },
        "F19": {"name": "VCA  Release",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 19 }, "value": 91 },
        "F20": {"name": "VCF  Attack",     "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 20 }, "value": 91 },
        "F21": {"name": "VCF  Decay",      "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 21 }, "value": 91 },
        "F22": {"name": "VCF  Sustain",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 22 }, "value": 91 },
        "F23": {"name": "VCF  Release",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 23 }, "value": 91 },
        ...
        "P2": {"name": "Glide",     "groups": ["FLT",], "set": "vpot_setter", "param": { "track": 2 }, "value": 64 },

        "B0": {"name": "Keyboard->Osc1",   "groups": ["OSC1-2", "OSC3-4", "ENV", "FLT"], "set": "vbutton_setter", "param": { "track": 0 }, "value": 127 },
        "B1": {"name": "Keyboard->Osc2",   "groups": ["OSC1-2", "OSC3-4", "ENV", "FLT"], "set": "vbutton_setter", "param": { "track": 1 }, "value": 127 },
        "B2": {"name": "Keyboard->Osc3",   "groups": ["OSC1-2", "OSC3-4", "ENV", "FLT"], "set": "vbutton_setter", "param": { "track": 2 }, "value": 0 },
        "B3": {"name": "Keyboard->Osc4",   "groups": ["OSC1-2", "OSC3-4", "ENV", "FLT"], "set": "vbutton_setter", "param": { "track": 3 }, "value": 0 },
    },
    "Oberheim": {
        "groups": [
