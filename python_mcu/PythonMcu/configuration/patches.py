...
patches = {
    ...
    "Minimoog": {
        ...
        "F12": {"name": "VCA  Attack",     "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 12 },  "value": 91 },
        "F13": {"name": "VCA  Decay",      "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 13 },  "value": 91 },
        "F14": {"name": "VCA  Sustain",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 14 }, "value": 91 },
        "F15": {"name": "VCA  Release",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 15 }, "value": 91 },
        "F16": {"name": "VCF  Attack",     "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 16 }, "value": 91 },
        "F17": {"name": "VCF  Decay",      "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 17 }, "value": 91 },
        "F18": {"name": "VCF  Sustain",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 18 }, "value": 91 },
        "F19": {"name": "VCF  Release",    "groups": ["ENV",],     "set": "vtrack_setter", "param": { "track": 19 }, "value": 91 },
